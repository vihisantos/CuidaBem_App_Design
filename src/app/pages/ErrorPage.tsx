    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <span className="text-[8rem] sm:text-[10rem] font-heading font-bold leading-none bg-gradient-to-br from-primary/20 to-destructive/20 bg-clip-text text-transparent select-none">
            {statusCode}
          </span>
        </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-8 max-w-sm mx-auto">
            {message}
          </p>
        </motion.div>
