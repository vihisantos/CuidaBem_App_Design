    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="relative h-64 bg-slate-900">
        ...
        <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center z-20">
          ...
          <button
            className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-colors hover:text-red-400"
          >
      ...
      <div className="relative -mt-12 px-6 z-30 animate-slide-up">
        ...
        <div className="mt-8">
          <Tabs defaultValue="about" className="w-full">
            <TabsList className="w-full grid grid-cols-2 bg-neutral-100/80 p-1.5 h-auto rounded-xl">
